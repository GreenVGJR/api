...
export default [infoYoutube, infoSoundcloud, infoSpotify, infoITunes, infoTwitterTweet, redditSubreddit, infoGiphy, infoTenor, googleWeather, infoKlipy, infoPinterest, infoTiktokVideo, redditPost] as any[];
