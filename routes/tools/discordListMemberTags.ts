...
import { DiscordListMemberTags } from "../../functions/request.js";
import { dispatch } from "../../functions/httpRequest.js";

const validTypes = ["all", "oldest", "newest", "oldest_guild", "newest_guild"];

app.get("/discord/listMember/tags", async (c) => {
	...
	const limit = queryLimit && Number.isInteger(parseInt(queryLimit)) ? Math.max(1, parseInt(queryLimit)) : null;
