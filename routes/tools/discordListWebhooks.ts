...
import { DiscordListWebhooks } from '../../functions/request.js';
import { dispatch } from '../../functions/httpRequest.js';

app.get('/discord/listWebhooks', async (c) => {
    ...
    return await dispatch(c, () => DiscordListWebhooks(token!, guildId, type));
});
